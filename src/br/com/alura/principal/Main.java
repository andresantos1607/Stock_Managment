        ...
        while (opcao != 0) {
            ...
            try {
                ...
                if (opcao == 1) {
                    ...
                    Produto produtoEncontrado = estoque.buscarProduto(codigoAtualizar);
                    ...
                    if (produtoEncontrado != null) {
                        ...
                        if (selecao == 1) {
                            ...
                            somaQuantidade = somaQuantidade + produtoEncontrado.getQuantidadeEstoque();
                            estoque.atualizarQuantidade(codigoAtualizar, somaQuantidade);
                            System.out.println("Estoque atualizado com sucesso!");

                        } else if (selecao == 2) {
                            System.out.println("Quanto foi removido?");
                            int subQuantidade = teclado.nextInt();
                            if (subQuantidade <= produtoEncontrado.getQuantidadeEstoque()) {
                                subQuantidade = produtoEncontrado.getQuantidadeEstoque() - subQuantidade;
                                estoque.atualizarQuantidade(codigoAtualizar, subQuantidade);
                                System.out.println("Estoque removido com sucesso!");

                            } else {
                                System.out.println("Quantidade maior que o contido no estoque");
                            }
